...
The documentation was generated by doxygen outputted to [html](BLABLA) and [Latex](BLABLA). In the html version, [MathJax](https://www.mathjax.org/) was used to draw the Latex formulae. Additionally to the usual description of functions and classes, the generated documentation also presents class diagrams.
